      ...
      <div class="row">
        ...
        <div class="col-md-6">
		  ...
		  <form action="upload.php" method="post" enctype="multipart/form-data"><br>
			...
			<input type="submit" class="btn btn-primary" value="Upload Image" name="submitImage"><br><br>
		</form>
        </div>
        ...
        <div class="col-md-6">
          ...
          <form action="profileUpdate.php" method="post">
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Gender:</label>
					<select name="gender" class="form-control" required data-validation-required-message="Please select you Gender">
					  <?php
					  echo '
		  ...
		  <div class="control-group form-group">
              <div class="controls">
                <label>Medium of Interest:</label>
					<select name="medium" class="form-control" required data-validation-required-message="Please select Medium">
					  <?php
					  echo
					  '<option value="None"></option>
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Profession:</label>
					<select name="profession" class="form-control" required data-validation-required-message="Please select you Profession">
					  <?php
					  echo
					  '
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Expected Student:</label>
					<select name="student" class="form-control" required data-validation-required-message="Please select Student">
					  <?php
					  echo
					  '<option value="None"></option>
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Subject of Interest 1:</label>
					<select name="sub1" class="form-control" required data-validation-required-message="Please select Subject">
					  <?php
					  echo
