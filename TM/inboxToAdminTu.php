...
//$conn->query("Update message set MssgSeen='2' where Tutor='".$_SESSION['Uname']."' and Student=''");
...
<br><h2>Messages</h>
	...
	<div class="col-md-11">
	<form action="mssgReplyAdminTu.php" method="post">
	<input type="text" class="form-control" name="nextMssg">
	
	<?php
	
			$sqlChtBox ="Select Message,Sender from message where Admin='sanjida@gmail.com' and Tutor='".$_SESSION['Uname']."' Order By IndexNum DESC";
			...
			$conn->query("Update message set MssgSeen='2' where Tutor='".$_SESSION['Uname']."' and Admin='sanjida@gmail.com' and Sender='3'");
