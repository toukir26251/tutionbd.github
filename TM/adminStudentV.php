	...
	<div class="row">
	  <div class="col-md-3">
		<div class="w3-container">
		  <ul class="w3-ul">  
			<li class="w3-xlarge"><i class="fa fa-address-card-o"></i> <a style="font-size:13px">Students Validation</a> </li>  
		  </ul>
		</div>
	  </div>
	   <div class="col-md-3">
      ...
      <!-- Portfolio Item Row -->
        ...
        <div class="col-md-12">
		<div class="card my">
		<h2 class="card-header" align="middle">Students</h2><br>
          <?php
      ...
      <!-- Related Projects Row -->
		...
		<button type="submit" class="btn btn-primary" name="AVStu">Activate Validity</button>
		</div>
      <!-- /.row -->
