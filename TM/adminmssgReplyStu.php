...
if(isset($_POST['SendBtn']))
{
	...
	$conn->query("Insert Into message(Student,Message,Tutor,Sender,Admin,MssgSeen) Values('".$_SESSION['stuReply']."','".$_POST['nextMssg']."','','3','".$_SESSION['Uname']."','1')");
...
header("Location: http://localhost/TM/adminInboxStu.php");
