  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Porfile Edit</li>
      </ol>
        ...
        <div class="col-md-6">
          ...
          <form action="profileUpdateStudent.php" method="post">
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Gender:</label>
					<select name="gender" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo '
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Giving Salary:</label>
					<select name="salary" class="form-control" required data-validation-required-message="Please select you Salary">
					  <?php
					  echo
					  '<option value="None"></option>
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Subject 1:</label>
					<select name="sub1" class="form-control" required data-validation-required-message="Please select a subject">
					  <?php
					  echo
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Day per Week:</label>
					<select name="day" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo
					  '<option value="'.$row["Day"].'" selected="selected">'.$row["Day"].'</option>
