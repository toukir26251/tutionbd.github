...
$sqlS = "SELECT * FROM `login` where Type='Student' and Validity='1' Order by Email ASC";
$sqlT = "SELECT * FROM `login` where Type='Tutor' and Validity='1' Order by Email ASC";
$resultS = $conn->query($sqlS);
$resultT = $conn->query($sqlT);
//$rowS = $resultS->fetch_assoc();
//$rowT = $resultT->fetch_assoc();

$sqlNew1 = "SELECT MssgSeen FROM Message where Admin='".$_SESSION['Uname']."' and Sender='1'";
$sqlNew2 = "SELECT MssgSeen FROM Message where Admin='".$_SESSION['Uname']."' and Sender='2'";
  ...
  <body>
    ...
    <div class="container">
     ...
     <div class="row">
	  ...
	  <div class="col-md-3">
      <!-- Page Heading/Breadcrumbs -->
	  <?php while($mssgNew = mysqli_fetch_array($resultNew2))
			{
				if($mssgNew['MssgSeen']=='1')
				{
					echo '<ul class="w3-ul">  
					<li class="w3-xxlarge"><i class="fa fa-briefcase">Tutor</i></li>  
					</ul>';
					break;
				}
			}				?>
	  ...
	  <div class="col-md-3">
      <!-- Page Heading/Breadcrumbs -->
	  <?php while($mssgNew = mysqli_fetch_array($resultNew1))
			{
				if($mssgNew['MssgSeen']=='1')
				{
					echo '<ul class="w3-ul">  
	...
	<div class="row">
	  <div class="col-md-3">
	   ...
	   <div class="col-md-3">
		<div class="w3-container">
		  <ul class="w3-ul">  
			<li class="w3-xlarge"><i class="fa fa-address-card"></i> <a style="font-size:13px" href="adminTutorV.php">Tutors Validation</a> </li>  
		  </ul>
		</div>
	  </div>
	  <div class="col-md-3">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
		<div class="card my">
		<h2 class="card-header" align="middle">Valid Students</h2><br>
          <?php
			echo "<table border='4'>
			<tr>
			<th>Email</th>
			...
			echo "<td>" . $rowS['BNum'] . "</td>";
			echo "<td>" . $rowS['TrxID'] . "</td>";
        ...
        <div class="col-md-6">
		<div class="card my">
          <h2 class="card-header" align="middle">Valid Tutors</h2><br>
          <?php
			echo "<table border='4'>
			<tr>
			<th>Email</th>
      ...
      <div class="row">
		...
		<div class="card my">
		<h2 class="card-header" align="middle">Change Validity Student</h2>
		<form method="post" action="UpdateValidity.php">
			<div class="control-group form-group">
              <div class="controls">
                <label>Email:</label>
				<input type="text" class="form-control" name="emailStu">
              </div>
			 </div>
			 <div class="control-group form-group">
              <div class="controls">
                <label>Date:</label>
				<input type="text" class="form-control" name="dateStu"><br>
              </div>
			 </div>
		</div><br>
		<button type="submit" class="btn btn-primary" name="DVStu">Deactivate Validity</button>
		</div>
      <!-- /.row -->
	  ...
	  <div class="col-md-6">
		...
		<div class="card my">
		<h2 class="card-header" align="middle">Change Validity Tutor</h2>
			<div class="control-group form-group">
              <div class="controls">
                <label>Email:</label>
		...
		<button type="submit" class="btn btn-primary" name="DVTu">Deactivate Validity</button>
        </form>
      </div>
    </div>
	<br>
