...
$sqlNew = "SELECT MssgSeen FROM Message where Student='".$_SESSION['Uname']."' and Sender = '2'";

$resultNew = $conn->query($sqlNew);

$sqlNewA = "SELECT MssgSeen FROM Message where Student='".$_SESSION['Uname']."' and Sender = '3'";
  ...
  <body>
    ...
    <div class="container">
	  ...
	  <?php while($mssgNew = mysqli_fetch_array($resultNew))
			{
				...
				{
					echo '<ul class="w3-ul">  
					<li class="w3-xxxlarge"><i class="fa fa-briefcase"></i></li>  
					</ul>';
					break;
				}
			}				?>
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Porfile(Student)</li>
      </ol>
      ...
      <div class="row">
        <div class="col-md-6">
          <h3>Personal Info</h3>
          <form action="saveChangeStu.php" method="post">
          ...
          <h3>More Info</h3>
          <form method="post" action="saveChangeStu.php">
			<div class="control-group form-group">
              <div class="controls">
                <label>Medium:</label>
