...
$sqlS = "SELECT FullName,PhoneNumber,Email,Location,Education,Salary,S1,S2,Day FROM reginfostu";
	  ...
	  <?php
		  ...
		  while($rowS = $resultS->fetch_assoc())
		  {
			  ...
			  <div class="card h-100">
				...
				<div class="card-body">
				  <p class="card-text">Student Name : '.$rowS['FullName'].' &nbsp Education: '.$rowS['Education'].' &nbsp Location : '.$rowS['Location'].' &nbsp Day : '.$rowS['Day'].'days a week &nbsp Salary : '.$rowS['Salary'].'</p>
				</div>
