          ...
          <form action="regConf.php" method="post">
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="text" class="form-control" name="name" placeholder="Your Full Name" required data-validation-required-message="Please enter your name.">
            ...
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="tel" class="form-control" name="phone"placeholder="Your Valid Phone Number" required data-validation-required-message="Please enter your phone number.">
              </div>
            </div>
            <div class="control-group form-group">
              <div class="controls">
                <label>Email Address:</label>
                <input type="email" class="form-control" name="email" placeholder="example@gmail.com" required data-validation-required-message="Please enter your email address.">
              </div>
            </div>
			 <div class="control-group form-group">
              <div class="controls">
            ...
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="text" class="form-control" name="education" placeholder="Class,Group(if any),Institution" required data-validation-required-message="Please enter your educational bio">
              </div>
            </div>
			<div class="control-group form-group">
              <div class="controls">
			...
			<div class="control-group form-group">
              <div class="controls" required data-validation-required-message="Please select one">
                ...
                <font color="green">Tutor &nbsp &nbsp &nbsp &nbsp &nbsp</font><input type="radio" name="tutor" value="Tutor" required data-validation-required-message="Please select one"><br>
				<font color="green">Student  &nbsp &nbsp &nbsp</font><input type="radio" name="tutor" value="Student" required data-validation-required-message="Please select one"><br>
              </div>
            </div>
