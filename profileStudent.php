  ...
  <body>
    ...
    <div class="container">
	  ...
	  <div class="w3-container">
		  <ul class="w3-ul">  
			<li class="w3-xxxlarge"><i class="fa fa-plug"></i> <a style="font-size:20px" href="inboxStu.php">Connected Teachers</a> </li>  
		  </ul>
		</div>
		</div>
		<div class="col-md-6">
		<div class="w3-container">
		  <ul class="w3-ul">  
			<li class="w3-xxxlarge"><i class="fa fa-handshake-o"></i> <a style="font-size:20px" href="inboxToAdmin.php">Concact to Admin</a> </li>  
		  </ul>
		</div>
	  </div>
	  </div>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <form action="profileUpdateStudent.php" method="post">
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="text" class="form-control" name="name" Value="<?php echo $row['FullName'] ?>" required data-validation-required-message="Please enter your name.">
            ...
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="tel" class="form-control" name="phone" Value="<?php echo $row['PhoneNumber'] ?>" required data-validation-required-message="Please enter your phone number.">
              </div>
            </div>
            <div class="control-group form-group">
              <div class="controls">
            ...
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="text" class="form-control" name="education" Value="<?php echo $row['Education'] ?>" required data-validation-required-message="Please enter your educational bio">
              </div>
            </div>
			<div class="control-group form-group">
              <div class="controls">
			...
			<button type="submit" class="btn btn-primary" name="saveChange1">Save Change</button><br><br>
		  </form>
          ...
          <form method="post" action="profileUpdateStudent.php">
			<div class="control-group form-group">
              <div class="controls">
                <label>Medium:</label>
					<select name="medium" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo
					  '<option value="None"></option>
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Class:</label>
					<select name="class" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo
					  '<option value="None"></option>
					  <option value="'.$row["Class"].'" selected="selected">'.$row["Class"].'</option>
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Giving Salary:</label>
					<select name="salary" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo
					  '<option value="None"></option>
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Subject 1:</label>
					<select name="sub1" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo
					  '<option value="'.$row["S1"].'" selected="selected">'.$row["S1"].'</option>
              ...
              <div class="controls">
                <label>Subject 2:</label>
					<select name="sub2" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo
					  '<option value="'.$row["S2"].'" selected="selected">'.$row["S2"].'</option>
					  <option value="All">All</option>
					  <option value="Math">Math</option>
					  <option value="English">English</option>
					  <option value="Physics" >Physics</option>
			...
			<button type="submit" class="btn btn-primary" name="saveChange2">Save Change</button><br><br>
		  </form>
        </div>
		...
		?>
		  <form action="profileUpdateStudent.php" method="post">
			<div class="card-body">
                ...
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <input type="radio" name="Wanted" value="yes"<?php echo $checkYes; ?>><font color="green">Yes</font>
                    </li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <input type="radio" name="Wanted" value="no"<?php echo $checkNo; ?>><font color="red">Not Now</font>
                    </li>
                  </ul>
                </div>
              </div>
			...
			<br>
		<button type="submit" class="btn btn-primary" name="saveChange3">Save Wanted Status</button><br><br>
		</form>
		</div>
