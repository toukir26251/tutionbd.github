...
$sql = "SELECT FullName,PhoneNumber,Email,Education,SOI1,SOI2,ExpectedStudent,Photo FROM reginfo Where Availability='yes' Limit 3";
$sqlS = "SELECT FullName,PhoneNumber,Email,Location,Education,Salary,S1,S2 FROM reginfostu Limit 8";
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <ul class="pagination justify-content-center mb-4">
            <li class="page-item">
              <a class="page-link" href="tutors.php">All &rarr;</a>
            </li>
          </ul>
          ...
          <div class="card mb-4">
			...
			<form action="homesearch.php" method="post">
              <div class="input-group">
                <input type="text" name="searchHome" class="form-control" placeholder="Search for...">
