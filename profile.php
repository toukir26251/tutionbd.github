			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Profession:</label>
					<select name="profession" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo
					  '
			...
			<div class="control-group form-group">
              <div class="controls">
                <label>Expected Student:</label>
					<select name="student" class="form-control" required data-validation-required-message="Please select you location">
					  <?php
					  echo
					  '<option value="None"></option>
